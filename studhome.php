...
<html>
<head>
	<title>Bishop Heber Higher Secondary School</title>
	<link
      rel="icon"
				...
				<div class="container">
					...
					<div class="nav-wrap">
						<nav class="nav-desktop">
							<ul class="menu-list">
								<li><a href="studhome.php">Student Home</a></li>
...
<input type="submit" name="btn"/>
	...
	<tr bgcolor="#38b0de">
		<td colspan="5" align="center"><h2>Attendance  Details</h2></td>
  </tr>
		...
		$qry=mysql_query("select * from atten where (date >= '$date' and date <= '$date1') && reg='$reg'");
		$i=1;
